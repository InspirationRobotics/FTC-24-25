...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1417.415842988081; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1002.5590730258658; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -225.28389487518865; // x position of the perpendicular encoder (in tick units)
    }
